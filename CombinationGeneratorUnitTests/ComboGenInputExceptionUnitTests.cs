...
namespace CombinationGeneratorUnitTests
{
    ...
    public class ComboGenInputExceptionUnitTests
    {
        ...
        public void TwoFatOneInputTest()
        {
            ...
            Assert.AreEqual("2-FAT was selected which exceeds the number of inputs provided: 1.  Please select 1-FAT or lower.", exceptionMessage);
        }
        ...
        public void ThreeFatTwoInputsTest()
        {
            ...
            Assert.AreEqual("3-FAT was selected which exceeds the number of inputs provided: 2.  Please select 2-FAT or lower.", exceptionMessage);
        }
        ...
        public void InputCount0Test()
        {
            ...
            Assert.AreEqual("Test Case Generation requires at least 1 input.", exceptionMessage);
        }
